...
export const TRANSLATIONS = {
  id: {
    ...
    loginSubtitle: "Masuk ke akun finansialmu",
    registerSubtitle: "Mulai kelola keuangan dengan mudah",
    ...
    fillAllFields: "Lengkapi semua kolom",
    ...
    uploadingDrive: "Mengunggah ke Drive...",
    pdfSuccess: "PDF berhasil diunduh!",
    driveSuccess: "Berhasil disimpan ke Google Drive!",
    driveError: "Gagal menyimpan ke Drive",
    driveLoginRequired: "Silakan login dengan Google terlebih dahulu untuk menggunakan fitur ini",
  ...
  en: {
    ...
    loginSubtitle: "Sign in to your financial account",
    registerSubtitle: "Start managing your finances easily",
    ...
    driveSuccess: "Successfully saved to Google Drive!",
    driveError: "Failed to save to Drive",
    driveLoginRequired: "Please sign in with Google first to use this feature",
